...
#
# Copies the engine sources (NOT the player's own Win32 shell) into
# third_party/player-engine/, and the player repo's already-flattened
# FFmpeg subset + committed config + build description verbatim, mirroring
# its layout so cmake/ffmpeg.cmake works unmodified from this repo's root.
...
# Engine translation units + headers; deliberately NOT src/main.cpp (the
# player's bundled shell — this repo has its own host code in src/main.cpp).
...
file(WRITE "${ROOT}/third_party/player-engine/PROVENANCE.txt"
  ...
  "Commit: ${commit}\n"
  "Files: ${ncount} engine sources (+ LICENSE), plus ${ffcount} files "
...
message(STATUS "vendored ${ncount} engine files + ${ffcount} ffmpeg files -> ${ROOT}/third_party")
