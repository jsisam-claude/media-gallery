@echo off
rem Media Gallery — plain MSVC build, no CMake needed.
...
cl /nologo /std:c++17 /O2 /W4 /EHsc /MT /GS /guard:cf ^
   ...
   src\player_stub.cpp MediaGallery.res /Fe:MediaGallery.exe ^
...
del /q main.obj decoder_gdiplus.obj decoder_wic.obj filmstrip.obj player_stub.obj MediaGallery.res 2>nul
echo Built MediaGallery.exe
